...
function(nl, nlDlg, nlResourceAddModifySrv, nlTreeSelect, nlServerApi) {
	...
	var _pollyVoices = [
		...
		{id:'goog:te-IN_te-IN-Standard-A', name:'Telangana Female voice: Soundarya'},
		{id:'goog:te-IN_te-IN-Standard-B', name:'Telangana Male voice: Ravi'},
		{id:'goog:ml-IN_ml-IN-Wavenet-A', name:'Malyalam Female voice: Nithya'},
		{id:'goog:ml-IN_ml-IN-Wavenet-B', name:'Malyalam Male voice: Jayaram'},
