...
function(nl, nlDlg, nlResourceAddModifySrv, nlTreeSelect, nlServerApi) {
	...
	var _pollyVoices = [
		...
		{id:'fr-FR_Celine', name:'French Female voice: Céline'},
		{id:'fr-FR_Lea', name:'French Female voice: Léa'},
		...
		{id:'is-IS_Dora', name:'Icelandic Female voice: Dóra/Dora'},
		...
		{id:'pt-BR_Vitoria', name:'Portuguese, Brazilian Female voice: Vitória/Vitoria'},
		{id:'pt-BR_Ricardo', name:'Portuguese, Brazilian Male voice: Ricardo'},
		{id:'pt-PT_Ines', name:'Portuguese, European Female voice: Inês/Ines'},
		...
		{id:'es-US_Penelope', name:'Spanish, US Female voice: Penélope/Penelope'},
