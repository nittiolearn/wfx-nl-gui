...
function Permission(nl) {
    ...
    var permissions = {
        ...
        '/course_summary_report': {login: true, permission: 'course_review', termRestriction: TR_CLOSED},
        ...
        '/training_list': {login: true, permission: 'training_manage', termRestriction: TR_CLOSED},
