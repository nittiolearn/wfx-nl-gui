...
function Permission(nl) {
    ...
    var permissions = {
        ...
        '/course_assign_list': {login: true, permission: 'assignment_send', termRestriction: TR_CLOSED},
        ...
        '/course_summary_report': {login: true, permission: 'assignment_send', termRestriction: TR_CLOSED},
        ...
        '/assignment_summary_report': {login: true, permission: 'assignment_send', termRestriction: TR_CLOSED},
