...
function(nl, nlRouter, $scope, nlDlg, nlCardsSrv, nlServerApi, nlSendAssignmentSrv, nlGroupInfo, nlTreeSelect, nlTrainingReport) {
	...
	function _getTraininghelp() {
		return {
			...
			module: {name: nl.t('Feedback form'), help: nl.t('Mandatory - Select the feedback form or the learning module for your training by clicking on the search icon.')},
			modulename: {name: nl.t('Feedback form'), help: nl.t('Mandatory - Select the feedback form or the learning module for your training by clicking on the search icon.')},
