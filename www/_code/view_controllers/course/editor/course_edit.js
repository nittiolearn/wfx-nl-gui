...
function(nl, nlDlg, nlServerApi, nlLessonSelect, nlExportLevel, nlRouter, nlCourseCanvas, nlMarkup, nlTreeSelect, nlResourceAddModifySrv, nlGroupInfo, nlExpressionProcessor) {
    ...
    var _moduleAttrHelp = {
		...
		complete_before: 'An item in the course is displayed as "delayed" to the lerner if they do not complete the item before the number of days specified in this field. The days are counted from start date of the course as defined when assigning the course. For example, if the start date and time is 15th August, 9:30 AM, and this field is set to 5, this item will be displayed as "delayed" after 9:30 AM on 20th August.',
