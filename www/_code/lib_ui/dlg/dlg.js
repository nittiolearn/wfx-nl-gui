    ...
    return {
        ...
        link: function($scope, iElem, iAttrs) {
            ...
            $scope.onClickOnPrev = function () {
                ...
                if (!($scope.canShowPrev() || nl.utils.getFnFromParentOrGrandParent($scope, 'canShowPrev')($scope.data))) return;
            ...
            $scope.onClickOnNext = function () {
                ...
                if (!($scope.canShowNext() || nl.utils.getFnFromParentOrGrandParent($scope, 'canShowNext')($scope.data))) return;
